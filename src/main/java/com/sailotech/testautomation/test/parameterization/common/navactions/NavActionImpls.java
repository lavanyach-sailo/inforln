...
public class NavActionImpls extends TestBase {
	...
	public static TestEnsureRequest login(JsonNode navActionParams, String file, String testCaseStepId)
			throws Throwable {
	 ...
	 * @throws Throwable
	 */
	public static TestEnsureRequest typeText(JsonNode navActionParams, String file, String testCaseStepId)
			throws Throwable {
		TestEnsureRequest testEnsureRequest = null;
	...
	public static TestEnsureRequest clickElement(JsonNode navActionParams, String file, String testCaseStepId)
			throws Throwable {
		TestEnsureRequest testEnsureRequest = null;
	...
	public static TestEnsureRequest clickLastElement(JsonNode navActionParams, String file, String testCaseStepId)
			throws Throwable {
		TestEnsureRequest testEnsureRequest = null;
		testEnsureRequest = processNavActionNode(navActionParams, ProcessConstants.CLICKLASTELEMENT, file,
				testCaseStepId);
		return testEnsureRequest;
	}

	public static TestEnsureRequest clickVisibleElement(JsonNode navActionParams, String file, String testCaseStepId)
			throws Throwable {
		TestEnsureRequest testEnsureRequest = null;
		testEnsureRequest = processNavActionNode(navActionParams, ProcessConstants.CLICKVISIBLEELEMENT, file,
				testCaseStepId);
		return testEnsureRequest;
	}

	public static TestEnsureRequest doubleClickElement(JsonNode navActionParams, String file, String testCaseStepId)
			throws Throwable {
		TestEnsureRequest testEnsureRequest = null;
		testEnsureRequest = processNavActionNode(navActionParams, ProcessConstants.DOUBLECLICKELEMENT, file,
				testCaseStepId);
		return testEnsureRequest;
	}

	public static TestEnsureRequest typeTextWithEnter(JsonNode navActionParams, String file, String testCaseStepId)
			throws Throwable {
		TestEnsureRequest testEnsureRequest = null;
		testEnsureRequest = processNavActionNode(navActionParams, ProcessConstants.TYPETEXTWITHENTER, file,
				testCaseStepId);
		return testEnsureRequest;
	}

	public static TestEnsureRequest typeTextWithTabKey(JsonNode navActionParams, String file, String testCaseStepId)
			throws Throwable {
		TestEnsureRequest testEnsureRequest = null;
		testEnsureRequest = processNavActionNode(navActionParams, ProcessConstants.TYPETEXTWITHTABKEY, file,
				testCaseStepId);
		return testEnsureRequest;
	}

	public static TestEnsureRequest textClearInputs(JsonNode navActionParams, String file, String testCaseStepId)
			throws Throwable {
		TestEnsureRequest testEnsureRequest = null;
	...
	public static TestEnsureRequest zoomOut(JsonNode navActionParams, String file, String testCaseStepId)
			throws Throwable {
		TestEnsureRequest testEnsureRequest = null;
		zoomIn();
		return testEnsureRequest;
	...
	public static TestEnsureRequest savePDF(JsonNode navActionParams, String file, String testCaseStepId)
			throws Throwable {
		...
		try {
			if (ignore == null)
				...
				case "id":
					 ...
					 * js.executeScript(selector); log.info("selector webelement" + webElement);
					 * webElement.click();
					 */
					// driver.navigate().to(src);
	...
	public static TestEnsureRequest extractDataFromPDF(JsonNode navActionParams, String file, String testCaseStepId)
			throws Throwable {
	...
	public static TestEnsureRequest zoom(JsonNode navActionParams, String file, String testCaseStepId)
			throws Throwable {
		TestEnsureRequest testEnsureRequest = null;
...
//			log.info("Variables"+variables.toString());
	...
	public static TestEnsureRequest switchToNewTab(JsonNode navActionParams, String file, String testCaseStepId)
			throws Throwable {
		TestEnsureRequest testEnsureRequest = null;
		String url = getJsonFieldValue(navActionParams, "url");
		log.info("URL---->" + url);
	...
	public static TestEnsureRequest closeTab(JsonNode navActionParams, String file, String testCaseStepId)
			throws Throwable {
		TestEnsureRequest testAssureRequest = null;
		ArrayList<String> w = new ArrayList<String>(driver.getWindowHandles());
		// log.info("URL---->" +url);
	...
	public static TestEnsureRequest refreshTab(JsonNode navActionParams, String file, String testCaseStepId)
			throws Throwable {
		TestEnsureRequest testAssureRequest = null;
		String url = getJsonFieldValue(navActionParams, "url");
		log.info("URL---->" + url);
	...
	public static TestEnsureRequest frameSwitch(JsonNode navActionParams, String file, String testCaseStepId)
			throws Throwable {
		TestEnsureRequest testEnsureRequest = null;
		Thread.sleep(2000);
		try {
			...
			case "xpath":
				 ...
				 * .getData(DataFlavor.stringFlavor); log.info("frame text -> " + text); }
				 */
				break;
			case "index":
	...
	public static TestEnsureRequest frameSwitchIndex(JsonNode navActionParams, String file, String testCaseStepId)
			throws Throwable {
		TestEnsureRequest testEnsureRequest = null;
		try {
			Thread.sleep(5000);
...
//			log.info("Numbers-->" + splitString[0]);
	...
	public static TestEnsureRequest readSessionInFileName(JsonNode navActionParams, String file,
...
//				log.info("Numbers-->" + splitString[0]);
	...
	public static TestEnsureRequest mapModuleToInforModule(JsonNode navActionParams, String file,
			String testCaseStepId) {
		TestEnsureRequest testEnsureRequest = null;
		String varModule = getJsonFieldValue(navActionParams, "varModule");
...
//		int cell = Integer.parseInt(cellValue);
	...
	public static TestEnsureRequest getText(JsonNode navActionParams, String file, String testCaseStepId)
			throws Throwable {
		TestEnsureRequest testEnsureRequest = null;
	...
	public static TestEnsureRequest clickPurchaseOrderAdvice(JsonNode navActionParams, String file,
			String testCaseStepId) throws Throwable {
		TestEnsureRequest testAssureRequest = null;
		testAssureRequest = processNavActionNode(navActionParams, ProcessConstants.CLICKPURCHASEORDERADVICE, file,
				testCaseStepId);
		return testAssureRequest;
	}

	public static TestEnsureRequest clickLastCheckBoxInList(JsonNode navActionParams, String file,
			String testCaseStepId) throws Throwable {
		TestEnsureRequest testAssureRequest = null;
		testAssureRequest = processNavActionNode(navActionParams, ProcessConstants.CLICKLASTCHECKBOXINLIST, file,
				testCaseStepId);
		return testAssureRequest;
	}

	public static TestEnsureRequest clickShadowElement(JsonNode navActionParams, String file, String testCaseStepId)
			throws Throwable {
		TestEnsureRequest testAssureRequest = null;
	...
	public static TestEnsureRequest splitText(JsonNode navActionParams, String file, String testCaseStepId)
			throws Throwable {
		TestEnsureRequest testEnsureRequest = null;
		try {
...
//
//	}
	public static TestEnsureRequest toArray(JsonNode navActionParams, String file, String testCaseStepId)
			throws Throwable {
		TestEnsureRequest testEnsureRequest = null;
		try {
			String varName = getJsonFieldValue(navActionParams, "varName");
	...
	public static TestEnsureRequest addElementsToArray(JsonNode navActionParams, String file, String testCaseStepId)
			throws Throwable {
		TestEnsureRequest testEnsureRequest = null;
	...
	public static TestEnsureRequest addElementsToList(JsonNode navActionParams, String file, String testCaseStepId)
			throws Throwable {
		TestEnsureRequest testEnsureRequest = null;
		log.info("Navactionparams is Array-->" + navActionParams.isArray());
		try {
	...
	public static TestEnsureRequest calculateCostAmount(JsonNode navActionParams, String file, String testCaseStepId)
			throws Throwable {
		TestEnsureRequest testEnsureRequest = null;
		try {
	...
	public static TestEnsureRequest readTaxData(JsonNode navActionParams, String file, String testCaseStepId)
			throws Throwable {
		TestEnsureRequest testEnsureRequest = null;
		try {
	...
	public static TestEnsureRequest compareTaxData(JsonNode navActionParams, String file, String testCaseStepId)
			throws Throwable {
		TestEnsureRequest testEnsureRequest = null;
		try {
	...
	public static TestEnsureRequest processNavActionNode(JsonNode navActionParams, String processType, String file,
			String testCaseStepId) throws Throwable {
		TestEnsureRequest testEnsureRequest = null;
		...
		try {
			...
			case ProcessConstants.CLICKPURCHASEORDERADVICE:
				...
				break;
			case ProcessConstants.CLICKLASTCHECKBOXINLIST:
				List<WebElement> elements = driver.findElements(By.xpath(finalXpath));
				log.info("click list elements -> " + elements.size());
				finalXpath = "(" + finalXpath + ")[" + elements.size() + "]";
